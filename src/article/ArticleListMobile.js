...
export class ArticleListMobile extends Component {
	...
	render() {
		...
		return (/Mobi|Android/i.test(navigator.userAgent)) && <React.Fragment>
			...
			{otherArticles && <ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={otherArticles} />}
			...
			{(this.props.articles_search_results && this.props.articles_search_results.data) && <React.Fragment>
				...
				<br />
				<ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={this.props.articles_search_results.data} />
			</React.Fragment>}
			...
			{(this.props.cancer && this.props.cancer.data) && <React.Fragment>
				...
				<br />
				<ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={this.props.cancer.data} />
			</React.Fragment>}
			...
			{(this.props.diabetes && this.props.diabetes.data) && <React.Fragment>
				...
				<br />
				<ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={this.props.diabetes.data} />
			</React.Fragment>}
			...
			{(this.props.heart_disease && this.props.heart_disease.data) && <React.Fragment>
				...
				<br />
				<ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={this.props.heart_disease.data} />
			</React.Fragment>}
			...
			{(this.props.articles_for_us && this.props.articles_for_us.data) && <React.Fragment>
				...
				<br />
				<ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={this.props.articles_for_us.data} />
			</React.Fragment>}
			...
			{(this.props.articles_for_uk && this.props.articles_for_uk.data) && <React.Fragment>
				...
				<br />
				<ArticleCardsMobile userId={userId} saveArticle={this.handleSaveForLater} removeSavedArticle={this.handleRemoveSavedArticle} items={this.props.articles_for_uk.data} />
			</React.Fragment>}
