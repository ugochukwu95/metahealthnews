...
const ArticleConnector = connect(mapStateToProps, mapDispatchToProps)(
	class extends Component {
		render() {
			return <Switch>
				<Route path={["/", "/headlines/:countryCode", "/search/:searchstring", "/about", "/saved-articles", "/article/:title/:id", "/hidden-sources"]} exact={true} render={ (routeProps) => <Article { ...this.props } { ...routeProps } cookies={this.props.cookies} />} />
				<Redirect to="/" />
			</Switch>
		}
